...
namespace Sqlite3Lean.select1.Query000101
...
/--
  ...
  Query: SELECT * FROM test1 WHERE f1<0
...
def program : Program := #[
  ...
  vdbeTransaction 0 0 9 "0" 1,  -- 10: Transaction
  vdbeInteger 0 2 0 "" 0,  -- 11: Integer
...
end Sqlite3Lean.select1.Query000101
