...
namespace Sqlite3Lean.select1.Query000019
...
def program : Program := #[
  ...
  vdbeAggStep 0 3 2 "count(1)" 1,  -- 5: AggStep
  vdbeNext 0 4 0 "" 1,  -- 6: Next
  vdbeAggFinal 2 1 0 "count(1)" 0,  -- 7: AggFinal
...
end Sqlite3Lean.select1.Query000019
