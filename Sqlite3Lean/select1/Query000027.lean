...
namespace Sqlite3Lean.select1.Query000027
...
/--
  ...
  Query: SELECT MIN(f1,f2) FROM test1
...
def program : Program := #[
  ...
  vdbeFunction 0 2 1 "min(-3)" 0,  -- 6: Function
  vdbeResultRow 1 1 0 "" 0,  -- 7: ResultRow
...
end Sqlite3Lean.select1.Query000027
