...
namespace Sqlite3Lean.select1.Query000139
...
def program : Program := #[
  ...
  vdbeColumn 0 2 3 "" 0,  -- 5: Column
  vdbeColumn 0 3 4 "" 0,  -- 6: Column
  vdbeColumn 0 4 5 "" 0,  -- 7: Column
  vdbeResultRow 1 5 0 "" 0,  -- 8: ResultRow
...
end Sqlite3Lean.select1.Query000139
