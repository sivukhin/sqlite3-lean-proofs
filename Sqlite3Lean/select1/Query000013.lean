...
namespace Sqlite3Lean.select1.Query000013
...
/--
  ...
  Query: SELECT test1.f1, test2.r1 FROM test2, test1
...
def program : Program := #[
  ...
  vdbeColumn 1 0 1 "" 0,  -- 5: Column
  vdbeColumn 0 0 2 "" 0,  -- 6: Column
  vdbeRealAffinity 2 0 0 "" 0,  -- 7: RealAffinity
  vdbeResultRow 1 2 0 "" 0,  -- 8: ResultRow
  vdbeNext 1 5 0 "" 1,  -- 9: Next
  vdbeNext 0 4 0 "" 1,  -- 10: Next
  vdbeHalt 0 0 0 "" 0,  -- 11: Halt
  vdbeTransaction 0 0 2 "0" 1,  -- 12: Transaction
...
end Sqlite3Lean.select1.Query000013
