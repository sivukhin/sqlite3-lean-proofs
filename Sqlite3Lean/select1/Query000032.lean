...
namespace Sqlite3Lean.Query000032
...
/--
  ...
  Query: SELECT max(f1,f2) FROM test1
...
def program : Program := #[
  ...
  .function 0 2 1 "max(-3)" 0,  -- 6: Function
  .resultRow 1 1 0 0 0,  -- 7: ResultRow
