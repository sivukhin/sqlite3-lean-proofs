...
namespace Sqlite3Lean.Query000050
...
def program : Program := #[
  ...
  .subtract 4 3 1 0 0,  -- 6: Subtract
  .makeRecord 1 2 5 0 0,  -- 7: MakeRecord
  .sorterInsert 1 5 1 2 0,  -- 8: SorterInsert
  .next 0 4 0 0 1,  -- 9: Next
  .openPseudo 2 6 3 0 0,  -- 10: OpenPseudo
  .sorterSort 1 16 0 0 0,  -- 11: SorterSort
  .sorterData 1 6 2 0 0,  -- 12: SorterData
  .column 2 1 2 0 0,  -- 13: Column
  .resultRow 2 1 0 0 0,  -- 14: ResultRow
  .sorterNext 1 12 0 0 0,  -- 15: SorterNext
  .halt 0 0 0 0 0,  -- 16: Halt
  .transaction 0 0 6 0 1,  -- 17: Transaction
  .integer 0 3 0 0 0,  -- 18: Integer
