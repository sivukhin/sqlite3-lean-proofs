...
namespace Sqlite3Lean.Query000121
...
def program : Program := #[
  ...
  .copy 7 9 0 0 2,  -- 21: Copy
  .copy 8 10 0 0 2,  -- 22: Copy
  .column 0 0 11 0 0,  -- 23: Column
  .column 0 1 12 0 0,  -- 24: Column
