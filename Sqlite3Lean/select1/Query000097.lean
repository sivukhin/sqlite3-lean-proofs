...
namespace Sqlite3Lean.Query000097
...
/--
  ...
  Query: SELECT f1 FROM test1 WHERE 4.3+2.4 OR 1 ORDER BY f1
...
def program : Program := #[
  ...
  .transaction 0 0 9 0 1,  -- 15: Transaction
